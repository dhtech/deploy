"""Entry point: python -m deployd --config /etc/deployd/config.yaml"""
...
from deployd import config as config_mod
from deployd.backends import create_backend
from deployd.backends.base import HwProvisioner
from deployd.daemon import HwManagerLoop, VmManagerLoop
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="deployd")
    parser.add_argument("--config", default="/etc/deployd/config.yaml")
